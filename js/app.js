...
function showNotes() {
  ...
  notesObj.forEach(function (element, index) {
    html += `
              <div class="noteCard my-2 mx-2 card" id="hi${index}" style="width: 18rem;">
                      <div class="card-body>
                          ...
                          <button id="${index}"onclick="important(this.id)" class="btn btn-success btn-sm">Mark as imp</button>
                      </div>
                  </div>`;
  });
...
function important(index) {
  document.getElementById('hi${index+1}').style.background = red ;
}
